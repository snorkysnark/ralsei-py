...
class RalseiCli:
    def __init__(self) -> None:
        ...
        """
        Mimics [ArgumentParser.add_argument()](https://docs.python.org/3/library/argparse.html#argparse.ArgumentParser.add_argument)
    ...
    def run(
        ...
        Args:
        - task_tree (`dict | Callable[[args], dict]`): a dictionary declaring the tasks
          or a function that receives [args](https://docs.python.org/3/library/argparse.html#argparse.Namespace)
          generated by `argparse` and returns a dictionary
        - credentials (str), optional: either `postgres://` url or a path to json file
