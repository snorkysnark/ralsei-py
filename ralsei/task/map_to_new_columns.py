...
class MapToNewColumns(Task):
    def __init__(
        ...
        - **fn**: a mapping function of type `(**kwargs) -> dict`,
          mapping a single row to values of the new columns.
        ...
        - **id_fields** (optional): columns that uniquely identify a row in **table**.
